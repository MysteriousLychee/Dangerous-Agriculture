...
public class ItemInit
{
    ...
    public static final RegistryObject<Item> HOLLYBERRY = ITEMS.register("hollyberry", () -> new BlockItem(BlockInit.HOLLYBERRY_BUSH.get(), new Item.Properties().tab(DangerousAgriculture.DANGEROUS_AGRICULTURE_TAB).food(new FoodProperties.Builder().alwaysEat().nutrition(1).saturationMod(2).effect(() -> new MobEffectInstance(MobEffects.POISON, 300, 0), 0.85f).effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 600, 0), 0.95f).effect(() -> new MobEffectInstance(MobEffects.BLINDNESS, 600, 0), 0.95F).build())));
