...
public class ItemInit
{
    ...
    public static final RegistryObject<Item> HALLUCINOGENIC_MUSHROOMS_ITEM = ITEMS.register("hallucinogenic_mushrooms_item", () -> new BlockItem(BlockInit.HALLUCINOGENIC_MUSHROOMS.get(), new Item.Properties().tab(DangerousAgriculture.DANGEROUS_AGRICULTURE_TAB).food((new FoodProperties.Builder().nutrition(2).saturationMod(4).effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 400, 0), 1f)).build()))); // TODO Make new effect called hallucinations for the mushroom (And possibly other things)
}
